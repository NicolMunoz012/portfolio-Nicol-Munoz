    ...
    academic: [
      {
        ...
        place: "Universidad",
        description: "Enfoque en fundamentos sólidos de diseño de software, algoritmos y desarrollo web moderno.",
      },
      {
        period: "2024 — 2024",
        title: "Fundamentos de Front-end",
        place: "Autoaprendizaje",
        description: "Profundicé en HTML, CSS y JavaScript con énfasis en diseño responsive y accesibilidad.",
      },
      {
        period: "2024 — 2025",
        title: "Sistemas UI y Prototipado",
        place: "Práctica de diseño",
        description: "Exploré patrones reutilizables, tokens de diseño y prototipado para interfaces cinematográficas.",
      },
      {
        period: "2025 — 2025",
        title: "3D en la Web",
        place: "Laboratorio personal",
        description: "Experimenté con Three.js y motion para crear fondos inmersivos y detalles interactivos.",
      },
      {
        period: "2025 — 2026",
        title: "Iteraciones del Portafolio",
        place: "Proyectos personales",
        description: "Construí y refiné un portafolio bilingüe con buen estilo, performance e interacciones suaves.",
      },
    ],
    work: [
      {
        ...
        place: "Remoto",
        description: "Entregué landing pages y mejoras de interfaz enfocadas en responsividad, detalle y performance.",
      },
      {
        period: "2024 — 2024",
        title: "Diseño Web Voluntario",
        place: "Comunidad",
        description: "Apoyé con diseño y construcción de pequeñas experiencias web para eventos y anuncios.",
      },
      {
        period: "2025 — 2025",
        title: "Proyecto en equipo (Académico)",
        place: "Ingeniería de Software",
        description: "Colaboré usando flujos con Git, UI por componentes y entregas iterativas.",
      },
      {
        period: "2025 — 2026",
        title: "Práctica (Placeholder)",
        place: "Empresa",
        description: "Contribuí con features, fixes y mejoras de UI mientras aprendía procesos profesionales.",
      },
    ],
  },
  testimonials: {
